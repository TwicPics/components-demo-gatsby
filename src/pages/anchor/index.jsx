    ...
    <div id="twic-anchor-container">
      <TwicWrapper gitHubUrl="src/pages/anchor/index.jsx">
        <TwicAbstract title="anchor property">
          ...
          <ul>
            <li>
              position the letterboxed image in its container in
              <Code>contain</Code>mode.
            </li>
            <li>
              determine what should be visible when the image is cropped
              in&nbsp;
              <span className="twic-code">cover</span> mode.
            </li>
          </ul>
          <p>
            Accepted values are<Code>top</Code>,<Code>bottom</Code>,
            <Code>left</Code>,<Code>right</Code>,<Code>top-left</Code>,
            <Code>top-right</Code>,<Code>bottom-left</Code>,
            <Code>bottom-right</Code>and
            <Code>center</Code>.
          </p>
          <p>
