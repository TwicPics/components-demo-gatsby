...
const TwicPlaceholder = () => {
  ...
  return (
    <div id="twic-placeholder-container">
      <TwicWrapper gitHubUrl="src/pages/placeholder/index.jsx">
        <TwicAbstract title="placeholder property">
          ...
          <p>
            ...
            your images: their size are reserved in the page before the images
            are actually loaded.
          </p>
          <p>
          ...
          <p>
            The browser is told to load a SVG version as a background image
            first, then to replace it with the full version later on.
          </p>
          <p>
        ...
        <div
          className={`twic-grid ${showPlaceholders ? `show-placeholders` : ``}`}
        >
