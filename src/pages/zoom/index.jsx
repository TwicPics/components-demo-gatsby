...
const TwicZoom = () => {
  ...
  return (
    <div id="twic-zoom-container">
      <TwicWrapper filename="pages/zoom/index.jsx">
        <TwicAbstract title="zoom property">
          <p>
            <strong>
              The <dfn>zoom property</dfn> allows you to display a{" "}
              <dfn>lazy-loaded enlarged</dfn> version of your image when you
              hover the mouse
            </strong>
            .
          </p>
          ...
          <ul>
            ...
            <li>
              can be set using the <Code>zoom</Code> prop of{" "}
              <Code>TwicImg</Code> component or through <Code>--twic-zoom</Code>
        ...
        <div className="twic-grid">
          <div className="twic-item">
            <TwicImg
              zoom={zoom}
              src="components/zoom/stamps-on-booklet.jpg"
              intrinic="2996x4502"
            />
            <span>
              <Code>zoom="{zoom}"</Code>
