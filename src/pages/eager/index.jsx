...
const TwicEager = () => {
  ...
  return (
    <div id="twic-eager-container">
      <TwicWrapper gitHubUrl="src/pages/eager/index.jsx">
        <div className="demo-container">
          <TwicAbstract title="eager property">
            <p>
              <strong>
                The <dfn>eager</dfn> property allows to disable lazy loading for
                a given media
              </strong>
              : associated specific media will start loading regardless of
              whether it is visible in the view port.
            </p>
            <p>
