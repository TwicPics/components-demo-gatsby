...
const TwicState = () => {
  ...
  return (
    <div id="twic-state-container">
      <TwicWrapper gitHubUrl="src/pages/state/index.jsx">
        <TwicAbstract title="state property and / or statechange event ">
          ...
          <ul>
            <li>
              <Code>new</Code>: when the img or video source has not started
              loading
            </li>
            <li>
            ...
            <li>
              <Code>error</Code>: when an error occurred while loading the img
              or video source
            </li>
          </ul>
          <p>
