...
const TwicBot = () => {
  ...
  return (
    <div id="twic-bot-container">
      <TwicWrapper gitHubUrl="src/pages/bot/index.jsx">
        <TwicAbstract title="bot property">
          ...
          <p>
            In the example bellow,<Code>bot</Code>has been set to
            "cover=400x400".
          </p>
          <p>
          ...
          <p>
            <strong>
              Sets your browser's user agent to a bot engine value
            </strong>
