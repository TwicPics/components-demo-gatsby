...
const TwicColorBlindness = () => {
  ...
  return (
    <div id="twic-color-blindness-container">
      <TwicWrapper gitHubUrl="src/pages/color-blindness/index.jsx">
        <TwicAbstract title="Color blindness filters">
          ...
          <p>
            The number provided must be between 0 and 1 and represents the
            degree of colour blindness to be corrected.
          </p>
        </TwicAbstract>
...
export default TwicColorBlindness;
